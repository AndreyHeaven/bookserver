...
public class OPDSController {
    ...
    @GetMapping(value = {"/genres", "/genres/{code}"})
    public Feed genres(@PathVariable(name = "code", required = false) String code) {
        return service.getGenres(code);
    }

    @GetMapping(value = {"/books"})
    public Feed books(@RequestParam(name = "genre", required = false) String genreCode,
        ...
        return service.getBooks(genreCode, authorId, pageable);
    }
