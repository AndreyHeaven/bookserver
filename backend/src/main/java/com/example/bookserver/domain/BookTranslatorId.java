...
@Embeddable
public class BookTranslatorId implements Serializable {
    ...
    public BookTranslatorId() {}
    public BookTranslatorId(Long bookId, Long personId) {
        this.bookId = bookId;
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof BookTranslatorId that)) return false;
